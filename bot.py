...
async def test(ctx, 내용: str):
    if 내용 == "우리핵안무":
        embed=discord.Embed(description="우리핵안무", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/0tJN50r/dnflgordksan.gif")
        await ctx.send(embed=embed)
        

    elif 내용 == "우리핵안녕":
        embed=discord.Embed(description="우리핵안녕", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/RgfHT8J/dnflgordkssud.gif")
        await ctx.send(embed=embed)
        

    elif 내용 == "우리핵드럼":
        embed=discord.Embed(description="우리핵드럼", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/QccRgHK/dnflgoremfja.gif")
        await ctx.send(embed=embed)
        

    elif 내용 == "우리핵박수":
        embed=discord.Embed(description="우리핵박수", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/0n38dCT/dnflgorqkrtn.gif")
        await ctx.send(embed=embed)

    elif 내용 == "우리핵갸우뚱":
        embed=discord.Embed(description="우리핵갸우뚱", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "앵무댄스":
        embed=discord.Embed(description="앵무댄스", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/gM3pJQx/dodaneostm.gif")
        await ctx.send(embed=embed)
    elif 내용 == "앵무선글":
        embed=discord.Embed(description="앵무선글", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/m6txyNv/dodantjsrmf.gif")
        await ctx.send(embed=embed)
    elif 내용 == "앵무팝콘":
        embed=discord.Embed(description="앵무팝콘", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/DfBNjpM/dodanvkqzhs.gif")
        await ctx.send(embed=embed)
    elif 내용 == "앵무혼란":
        embed=discord.Embed(description="앵무혼란", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "RGB뽕":
        embed=discord.Embed(description="RGB뽕", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/Z65ttZx/RGBQhd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "RGB그자체":
        embed=discord.Embed(description="RGB그자체", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "사수웃음":
        embed=discord.Embed(description="사수웃음", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/N1rGd22/tktndntdma.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수화남":
        embed=discord.Embed(description="사수화남", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/6WD90vm/tktnghkska.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수자랑":
        embed=discord.Embed(description="사수자랑", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/nncpZXx/tktnwkfkd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수썬글":
        embed=discord.Embed(description="사수썬글", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/sP9nZTV/tktn-Tjsrmf.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수클럽":
        embed=discord.Embed(description="사수클럽", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "냥경악":
        embed=discord.Embed(description="냥경악", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/gDB9mzd/sidruddkr.gif")
        await ctx.send(embed=embed)
        
    elif 내용 == "냥슬픔":
        embed=discord.Embed(description="냥슬픔", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/VxZ3g53/sidtmfvma.gif")
        await ctx.send(embed=embed)
        
    elif 내용 == "냥선글":
        embed=discord.Embed(description="냥선글", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/fXgGK2s/sidtjsrmf.gif")
        await ctx.send(embed=embed)
        
    elif 내용 == "냥정색":
        embed=discord.Embed(description="냥정색", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "믿거애":
        embed=discord.Embed(description="믿거애", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/ByvWfmF/alerjdo.png")
        await ctx.send(embed=embed)
    elif 내용 == "믿거앱":
        embed=discord.Embed(description="믿거앱", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/VV3Xzth/alerjdoq.png")
        await ctx.send(embed=embed)
    elif 내용 == "믿거한":
        embed=discord.Embed(description="믿거한", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/Qbn3w3Q/alerjgks.png")
        await ctx.send(embed=embed)
    elif 내용 == "믿거시":
        embed=discord.Embed(description="믿거시", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "제리메롱":
        embed=discord.Embed(description="제리메롱", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/2ymkqL0/wpflapfhd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리처먹":
        embed=discord.Embed(description="제리처먹", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/wsD8mfj/wpflcjajr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리띠용":
        embed=discord.Embed(description="제리띠용", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/whdv6J4/wpflEldyd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리화들짝":
        embed=discord.Embed(description="제리화들짝", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/qDn4516/wpflghkemfWkr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리경악":
        embed=discord.Embed(description="제리경악", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/ngM8DtF/wpflruddkr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리쯧쯧":
        embed=discord.Embed(description="제리쯧쯧", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/1rNnyPY/wpflWmtWmt.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리끄덕":
        embed=discord.Embed(description="제리끄덕", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/5rNjbsz/wpflRmejr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리인사":
        embed=discord.Embed(description="제리인사", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/Gs7sNxZ/wpfldlstk2.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리폭소":
        embed=discord.Embed(description="제리폭소", color=0x789ce8)
...
async def test(ctx, 내용: str):
    if 내용 == "컴붕앱등":
        embed=discord.Embed(description="컴붕앱등", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/jhkPpD2/zjaqnddoqemd.png")
        await ctx.send(embed=embed)
    elif 내용 == "컴붕인텔":
        embed=discord.Embed(description="컴붕인텔", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/8dWKMwh/zjaqnddlsxpf.png")
        await ctx.send(embed=embed)
    elif 내용 == "컴붕RGB":
        embed=discord.Embed(description="컴붕RGB", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/XSLnkk8/zjaqnd-RGB.png")
        await ctx.send(embed=embed)
    elif 내용 == "컴붕특가":
        embed=discord.Embed(description="컴붕특가", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/JK9x5Q3/zjaqndxmrrk.png")
        await ctx.send(embed=embed)
    elif 내용 == "컴붕발열":
        embed=discord.Embed(description="컴붕발열", color=0x789ce8)
        embed.set_image(url="https://i.ibb.co/7KzCQ8N/zjaqndqkfduf.png")
        await ctx.send(embed=embed)
        
@slash.slash(name="고티", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 고티(ctx):
    embed=discord.Embed(description="고티", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/yVYpvGn/rhxl.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="님폰없", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 님폰없(ctx):
    embed=discord.Embed(description="님폰없", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/BBZY0ZY/slavhsdjqt.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="능지", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 능지(ctx):
    embed=discord.Embed(description="능지", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/zPhLbCK/smdwl.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="상담", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 상담(ctx):
    embed=discord.Embed(description="상담", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/FhHh34G/tkdeka.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="사용자", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 사용자(ctx):
    embed=discord.Embed(description="사용자", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/C0Ny77Q/tkdydwk.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="팟지", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 팟지(ctx):
    embed=discord.Embed(description="팟지", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/3scVVPh/vktwl.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="라데온", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 라데온(ctx):
    embed=discord.Embed(description="라데온", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/TgQS38s/fkepdhs.gif")
    await ctx.send(embed=embed)
    
@slash.slash(name="양심", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 양심(ctx):
    embed=discord.Embed(description="양심", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/cQTkgD0/didtla.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="이글쓰", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 이글쓰(ctx):
    embed=discord.Embed(description="이글쓰", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/mDnLbht/dlrmfTm.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="이파쓰", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 이파쓰(ctx):
    embed=discord.Embed(description="이파쓰", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/6J1PQKP/dlvkTm.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="라이젠", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 라이젠(ctx):
    embed=discord.Embed(description="라이젠", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/mzF9KZm/fkdlwps.gif")
    await ctx.send(embed=embed)
    
@slash.slash(name="IT", description="디시콘을 보내줌", guild_ids=guild_ids)
async def IT(ctx):
    embed=discord.Embed(description="IT", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/wd98YM0/IT.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="대부분버그", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 대부분버그(ctx):
    embed=discord.Embed(description="대부분버그", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/Fq46YmD/eoqnqnsqjrm.gif")
    await ctx.send(embed=embed)
    
@slash.slash(name="계산중", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 계산중(ctx):
    embed=discord.Embed(description="계산중", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/NK7fTYK/rPtkswnd.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="짜잔", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 짜잔(ctx):
    embed=discord.Embed(description="짜잔", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/3pkXM2D/Wkwks.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="그런겜", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 그런겜(ctx):
    embed=discord.Embed(description="그런겜", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/JmXyHtD/rmfjsrpa.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="이륙", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 이륙(ctx):
    embed=discord.Embed(description="이륙", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/s9B1Ghq/dlfbr.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="존버또존버", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 존버또존버(ctx):
    embed=discord.Embed(description="존버또존버", color=0x789ce8)
    embed.set_image(url="https://i.ibb.co/mGG923D/whsqj-Ehwhsqj.png")
    await ctx.send(embed=embed)
    
@slash.slash(name="의외로정상", description="디시콘을 보내줌", guild_ids=guild_ids)
async def 의외로정상(ctx):
    embed=discord.Embed(description="의외로정상", color=0x789ce8)
