...
async def test(ctx, 내용: str):
    if 내용 == "앵무댄스":
        ...
        embed=discord.Embed(description="앵무혼란", color=0xFFFFFF)
...
async def test(ctx, 내용: str):
    if 내용 == "사수웃음":
        embed=discord.Embed(description="사수웃음", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/N1rGd22/tktndntdma.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수화남":
        embed=discord.Embed(description="사수화남", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/6WD90vm/tktnghkska.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수자랑":
        embed=discord.Embed(description="사수자랑", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/nncpZXx/tktnwkfkd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수썬글":
        embed=discord.Embed(description="사수썬글", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/sP9nZTV/tktn-Tjsrmf.gif")
        await ctx.send(embed=embed)
    elif 내용 == "사수클럽":
        embed=discord.Embed(description="사수클럽", color=0xFFFFFF)
...
async def test(ctx, 내용: str):
    if 내용 == "제리메롱":
        embed=discord.Embed(description="제리메롱", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/2ymkqL0/wpflapfhd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리처먹":
        embed=discord.Embed(description="제리처먹", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/wsD8mfj/wpflcjajr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리띠용":
        embed=discord.Embed(description="제리띠용", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/whdv6J4/wpflEldyd.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리화들짝":
        embed=discord.Embed(description="제리화들짝", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/qDn4516/wpflghkemfWkr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리경악":
        embed=discord.Embed(description="제리경악", color=0xFFFFFF)
        embed.set_image(url="https://i.ibb.co/ngM8DtF/wpflruddkr.gif")
        await ctx.send(embed=embed)
    elif 내용 == "제리쯧쯧":
        embed=discord.Embed(description="제리쯧쯧", color=0xFFFFFF)
...
async def 존버또존버(ctx):
    embed=discord.Embed(description="존버또존버", color=0xFFFFFF)
...
async def 의외로정상(ctx):
    embed=discord.Embed(description="의외로정상", color=0xFFFFFF)
