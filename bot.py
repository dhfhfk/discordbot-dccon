...
@slash.slash(name="우리핵쌍안경", description="디시콘을 보내줌")
...
@slash.slash(name="RGB스트립", description="디시콘을 보내줌")
